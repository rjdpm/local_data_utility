...
#     return -vmf.entropy() + hyu.entropy()
    # SOUMITRA
    vmf_entropy_value = -vmf.entropy()
    hyu_entropy_value = hyu.entropy()
#     print('vmf entropy at line 212 in von_mises_fisher.py: {}' .format(vmf_entropy_value)) # SOUMITRA
#     print('hyu entropy at line 212 in von_mises_fisher.py: {}' .format(hyu_entropy_value)) # SOUMITRA
    return vmf_entropy_value + hyu_entropy_value
